...
function init_wp_rest_multiple_post_type_endpoint() {
	$controller = new WP_REST_MultiplePostTypes_Controller();
...
class WP_REST_MultiplePostTypes_Controller extends WP_REST_Controller {

	public function __construct() {
		$this->version = '1';
		$this->namespace = 'wp-bd/v' . $this->version;
		$this->rest_base = 'multiple-post-types';
	}
